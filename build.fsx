...
let project = "Exira.SimpleHttpServer"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "Exira.SimpleHttpServer is a simple HTTP server to serve static files"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Exira.SimpleHttpServer is a simple HTTP server to serve static files"
...
let gitName = "simple-http-server"
