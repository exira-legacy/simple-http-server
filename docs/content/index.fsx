...
For more information see the [License file][license] in the GitHub repository.
  ...
  [content]: https://github.com/exira/simple-http-server/tree/master/docs/content
  [gh]: https://github.com/exira/simple-http-server
  [issues]: https://github.com/exira/simple-http-server/issues
  [readme]: https://github.com/exira/simple-http-server/blob/master/README.md
  [license]: https://github.com/exira/simple-http-server/blob/master/LICENSE.txt
*)
