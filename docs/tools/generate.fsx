...
let referenceBinaries = [ "simple-http-server\\simple-http-server.exe" ]
// Web site location for the generated documentation
let website = "/simple-http-server"

let githubLink = "http://github.com/exira/simple-http-server"

// Specify more information about your project
let info =
  [ "project-name", "simple-http-server"
    "project-author", "exira"
    "project-summary", "Exira.SimpleHttpServer is a simple HTTP server to serve static files"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Exira.SimpleHttpServer" ]
